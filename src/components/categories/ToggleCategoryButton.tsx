...
export function ToggleCategoryButton({
  ...
  const description = active
    ? "Essa categoria não aparecerá mais nos novos lançamentos, mas continuará no histórico."
    : "Essa categoria voltará a aparecer nos novos lançamentos.";
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-[#070A12] p-6 shadow-2xl">
            ...
            <form action={toggleCategoryStatusAction} className="mt-6 flex gap-3">
