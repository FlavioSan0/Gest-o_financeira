...
import { TransactionsResponsibleSummary } from "./TransactionsResponsibleSummary";
    ...
    <div className="grid gap-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <article className="app-card p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-bold app-faint-text">Entradas filtradas</p>
        ...
        <article className="app-card p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-bold app-faint-text">Saídas filtradas</p>
        ...
        <article className="app-card p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-bold app-faint-text">Registros filtrados</p>
              <strong className="mt-2 block text-2xl font-black text-white">
